...
vk::DescriptorSetLayout vkInit::make_descriptor_set_layout(const vk::Device& device,
...
vk::DescriptorPool vkInit::make_descriptor_pool(const vk::Device& logicalDevice,
